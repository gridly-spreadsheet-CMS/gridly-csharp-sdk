...
${nuget_cmd} install src/Com.Gridly/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.Gridly.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.Gridly.dll \
-recurse:'src/Com.Gridly/*.cs' \
-doc:bin/Com.Gridly.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.Gridly.dll was created successfully"
fi
