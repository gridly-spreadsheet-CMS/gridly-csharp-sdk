...
namespace Com.Gridly.Api
{
    ...
    public interface IGridApi : IApiAccessor
    {
        ...
        List<Grid> List (string dbId, string query = default(string));
        ...
        ApiResponse<List<Grid>> ListWithHttpInfo (string dbId, string query = default(string));
        /// <summary>
        /// listFiles
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Grid>> ListAsync (string dbId, string query = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Grid>>> ListWithHttpInfoAsync (string dbId, string query = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// listFiles
        /// </summary>
        /// <remarks>
    ...
    public partial class GridApi : IGridApi
    {
        ...
        /// <param name="query">query (optional, default to &quot;{}&quot;)</param>
        /// <returns>List<Grid></returns>
        public List<Grid> List (string dbId, string query = default(string))
        {
             ApiResponse<List<Grid>> localVarResponse = ListWithHttpInfo(dbId, query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">query (optional, default to &quot;{}&quot;)</param>
        /// <returns>ApiResponse of List<Grid></returns>
        public ApiResponse<List<Grid>> ListWithHttpInfo (string dbId, string query = default(string))
        {
            // verify the required parameter 'dbId' is set
            if (dbId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List<Grid></returns>
        public async System.Threading.Tasks.Task<List<Grid>> ListAsync (string dbId, string query = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<Grid>> localVarResponse = await ListWithHttpInfoAsync(dbId, query, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;Grid&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Grid>>> ListWithHttpInfoAsync (string dbId, string query = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'dbId' is set
            if (dbId == null)
                throw new ApiException(400, "Missing required parameter 'dbId' when calling GridApi->List");
