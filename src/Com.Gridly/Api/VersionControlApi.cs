...
namespace Com.Gridly.Api
{
    ...
    /// </summary>
    public interface IVersionControlApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Branch> CreateAsync (string gridId, CreateBranch createBranch, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Branch>> CreateWithHttpInfoAsync (string gridId, CreateBranch createBranch, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// delete
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task MergeAsync (string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> MergeWithHttpInfoAsync (string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class VersionControlApi : IVersionControlApi
    {
        ...
        /// <returns></returns>
        public VersionControlApi(Com.Gridly.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<Branch> localVarResponse = CreateWithHttpInfo(gridId, createBranch);
        ...
        /// <param name="createBranch">createBranch</param>
        /// <returns>ApiResponse of Branch</returns>
        public ApiResponse<Branch> CreateWithHttpInfo (string gridId, CreateBranch createBranch)
        {
            // verify the required parameter 'gridId' is set
            if (gridId == null)
                throw new ApiException(400, "Missing required parameter 'gridId' when calling VersionControlApi->Create");
            // verify the required parameter 'createBranch' is set
            if (createBranch == null)
                throw new ApiException(400, "Missing required parameter 'createBranch' when calling VersionControlApi->Create");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Branch</returns>
        public async System.Threading.Tasks.Task<Branch> CreateAsync (string gridId, CreateBranch createBranch, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Branch> localVarResponse = await CreateWithHttpInfoAsync(gridId, createBranch, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Branch)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Branch>> CreateWithHttpInfoAsync (string gridId, CreateBranch createBranch, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'gridId' is set
            if (gridId == null)
                throw new ApiException(400, "Missing required parameter 'gridId' when calling VersionControlApi->Create");
        ...
        public ApiResponse<Object> DeleteWithHttpInfo (string branchId)
        {
            ...
            if (branchId == null)
                throw new ApiException(400, "Missing required parameter 'branchId' when calling VersionControlApi->Delete");
        ...
        public ApiResponse<Branch> GetWithHttpInfo (string branchId)
        {
            // verify the required parameter 'branchId' is set
            if (branchId == null)
                throw new ApiException(400, "Missing required parameter 'branchId' when calling VersionControlApi->Get");
        ...
        public ApiResponse<List<Branch>> ListWithHttpInfo (string gridId)
        {
            // verify the required parameter 'gridId' is set
            if (gridId == null)
                throw new ApiException(400, "Missing required parameter 'gridId' when calling VersionControlApi->List");
        ...
        /// <param name="mergeRecordOptions">mergeRecordOptions (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> MergeWithHttpInfo (string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>))
        {
            // verify the required parameter 'branchId' is set
            if (branchId == null)
                throw new ApiException(400, "Missing required parameter 'branchId' when calling VersionControlApi->Merge");
            // verify the required parameter 'destinationBranchId' is set
            if (destinationBranchId == null)
                throw new ApiException(400, "Missing required parameter 'destinationBranchId' when calling VersionControlApi->Merge");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task MergeAsync (string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             await MergeWithHttpInfoAsync(branchId, destinationBranchId, mergeRecordOptions, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> MergeWithHttpInfoAsync (string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'branchId' is set
            if (branchId == null)
                throw new ApiException(400, "Missing required parameter 'branchId' when calling VersionControlApi->Merge");
