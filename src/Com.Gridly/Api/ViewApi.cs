...
namespace Com.Gridly.Api
{
    ...
    public interface IViewApi : IApiAccessor
    {
        ...
        System.IO.Stream Export (string viewId, List<string> columnIds = default(List<string>), ExportFileHeader? fileHeader = default(ExportFileHeader?), string query = default(string), string sort = default(string), FileType? type = default(FileType?));
        ...
        ApiResponse<System.IO.Stream> ExportWithHttpInfo (string viewId, List<string> columnIds = default(List<string>), ExportFileHeader? fileHeader = default(ExportFileHeader?), string query = default(string), string sort = default(string), FileType? type = default(FileType?));
        /// <summary>
        /// get
        /// </summary>
        /// <remarks>
        ...
        Task Merge (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>));
        ...
        ApiResponse<Task> MergeWithHttpInfo (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>));
        ...
        System.Threading.Tasks.Task<Task> MergeAsync (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Task>> MergeWithHttpInfoAsync (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ViewApi : IViewApi
    {
        ...
        public ApiResponse<Object> DeleteWithHttpInfo (string viewId)
        {
            ...
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling ViewApi->Delete");
        ...
        /// <param name="type">type (optional)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream Export (string viewId, List<string> columnIds = default(List<string>), ExportFileHeader? fileHeader = default(ExportFileHeader?), string query = default(string), string sort = default(string), FileType? type = default(FileType?))
        {
        ...
        /// <param name="type">type (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> ExportWithHttpInfo (string viewId, List<string> columnIds = default(List<string>), ExportFileHeader? fileHeader = default(ExportFileHeader?), string query = default(string), string sort = default(string), FileType? type = default(FileType?))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
        ...
        /// <param name="mergeRecordOptions">mergeRecordOptions (optional)</param>
        /// <returns>Task</returns>
        public Task Merge (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>))
        {
             ApiResponse<Task> localVarResponse = MergeWithHttpInfo(destinationViewId, viewId, mergeBranchRequest, mergeRecordOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="mergeRecordOptions">mergeRecordOptions (optional)</param>
        /// <returns>ApiResponse of Task</returns>
        public ApiResponse<Task> MergeWithHttpInfo (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>))
        {
            ...
            if (mergeBranchRequest == null)
                throw new ApiException(400, "Missing required parameter 'mergeBranchRequest' when calling ViewApi->Merge");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Task</returns>
        public async System.Threading.Tasks.Task<Task> MergeAsync (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Task> localVarResponse = await MergeWithHttpInfoAsync(destinationViewId, viewId, mergeBranchRequest, mergeRecordOptions, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Task)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Task>> MergeWithHttpInfoAsync (string destinationViewId, string viewId, MergeBranchRequest mergeBranchRequest, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'destinationViewId' is set
            if (destinationViewId == null)
                throw new ApiException(400, "Missing required parameter 'destinationViewId' when calling ViewApi->Merge");
