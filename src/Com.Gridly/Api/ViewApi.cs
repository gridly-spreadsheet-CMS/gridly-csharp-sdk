...
namespace Com.Gridly.Api
{
    ...
    public interface IViewApi : IApiAccessor
    {
        ...
        /// <param name="createView">createView</param>
        ...
        System.Threading.Tasks.Task<System.IO.Stream> ExportAsync (string viewId, List<string> columnIds = default(List<string>), string fileHeader = default(string), string query = default(string), string sort = default(string), string type = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task MergeAsync (string destinationViewId, string viewId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> MergeWithHttpInfoAsync (string destinationViewId, string viewId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ViewApi : IViewApi
    {
        ...
        /// <param name="type">type (optional, default to csv)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> ExportWithHttpInfo (string viewId, List<string> columnIds = default(List<string>), string fileHeader = default(string), string query = default(string), string sort = default(string), string type = default(string))
        {
        ...
        public ApiResponse<Object> ImportViewWithHttpInfo (string viewId, System.IO.Stream file, string importRequest = default(string), string type = default(string))
        {
            ...
            if (importRequest != null) localVarFormParams.Add("importRequest", this.Configuration.ApiClient.ParameterToString(importRequest)); // form parameter
        ...
        /// <param name="mergeRecordOptions">mergeRecordOptions (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> MergeWithHttpInfo (string destinationViewId, string viewId, List<string> mergeRecordOptions = default(List<string>))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task MergeAsync (string destinationViewId, string viewId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             await MergeWithHttpInfoAsync(destinationViewId, viewId, mergeRecordOptions, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> MergeWithHttpInfoAsync (string destinationViewId, string viewId, List<string> mergeRecordOptions = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'destinationViewId' is set
            if (destinationViewId == null)
                throw new ApiException(400, "Missing required parameter 'destinationViewId' when calling ViewApi->Merge");
