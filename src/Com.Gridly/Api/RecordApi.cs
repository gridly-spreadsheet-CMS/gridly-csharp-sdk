...
namespace Com.Gridly.Api
{
    ...
    public interface IRecordApi : IApiAccessor
    {
        ...
        ApiResponse<Record> UpdateRecordWithHttpInfo (string id, string viewId, SetRecord updateRecordDTO);
        ...
        System.Threading.Tasks.Task<Record> UpdateRecordAsync (string id, string viewId, SetRecord updateRecordDTO, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Record>> UpdateRecordWithHttpInfoAsync (string id, string viewId, SetRecord updateRecordDTO, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class RecordApi : IRecordApi
    {
        ...
        /// <param name="updateRecordDTO">updateRecordDTO</param>
        /// <returns>Record</returns>
        public Record UpdateRecord (string id, string viewId, SetRecord updateRecordDTO)
        {
             ApiResponse<Record> localVarResponse = UpdateRecordWithHttpInfo(id, viewId, updateRecordDTO);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateRecordDTO">updateRecordDTO</param>
        /// <returns>ApiResponse of Record</returns>
        public ApiResponse<Record> UpdateRecordWithHttpInfo (string id, string viewId, SetRecord updateRecordDTO)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Record</returns>
        public async System.Threading.Tasks.Task<Record> UpdateRecordAsync (string id, string viewId, SetRecord updateRecordDTO, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Record> localVarResponse = await UpdateRecordWithHttpInfoAsync(id, viewId, updateRecordDTO, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Record)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Record>> UpdateRecordWithHttpInfoAsync (string id, string viewId, SetRecord updateRecordDTO, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling RecordApi->UpdateRecord");
