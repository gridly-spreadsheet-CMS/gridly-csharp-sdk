...
namespace Com.Gridly.Api
{
    ...
    public interface IRecordApi : IApiAccessor
    {
        ...
        ApiResponse<System.IO.Stream> DownloadRecordHistoriesWithHttpInfo (string viewId, string taskId);
        /// <summary>
        ...
        ApiResponse<Task> ExportRecordHistoriesWithHttpInfo (string viewId, ExportRecordHistory exportRecordHistory);
        /// <summary>
        /// fetch
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<RecordHistory>> FetchHistoriesWithHttpInfo (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest);
        /// <summary>
        /// update
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<System.IO.Stream> DownloadRecordHistoriesAsync (string viewId, string taskId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> DownloadRecordHistoriesWithHttpInfoAsync (string viewId, string taskId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// exportRecordHistories
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Task> ExportRecordHistoriesAsync (string viewId, ExportRecordHistory exportRecordHistory, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Task>> ExportRecordHistoriesWithHttpInfoAsync (string viewId, ExportRecordHistory exportRecordHistory, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// fetch
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<RecordHistory>> FetchHistoriesAsync (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<RecordHistory>>> FetchHistoriesWithHttpInfoAsync (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// update
        /// </summary>
        /// <remarks>
    ...
    public partial class RecordApi : IRecordApi
    {
        ...
        /// <param name="taskId">taskId</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream DownloadRecordHistories (string viewId, string taskId)
        {
             ApiResponse<System.IO.Stream> localVarResponse = DownloadRecordHistoriesWithHttpInfo(viewId, taskId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="taskId">taskId</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> DownloadRecordHistoriesWithHttpInfo (string viewId, string taskId)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling RecordApi->DownloadRecordHistories");
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling RecordApi->DownloadRecordHistories");

            var localVarPath = "/v1/views/{viewId}/record-histories/export/{taskId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DownloadRecordHistories", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> DownloadRecordHistoriesAsync (string viewId, string taskId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await DownloadRecordHistoriesWithHttpInfoAsync(viewId, taskId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> DownloadRecordHistoriesWithHttpInfoAsync (string viewId, string taskId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling RecordApi->DownloadRecordHistories");
        ...
        /// <param name="exportRecordHistory"></param>
        /// <returns>Task</returns>
        public Task ExportRecordHistories (string viewId, ExportRecordHistory exportRecordHistory)
        {
             ApiResponse<Task> localVarResponse = ExportRecordHistoriesWithHttpInfo(viewId, exportRecordHistory);
             return localVarResponse.Data;
        }
        ...
        /// <param name="exportRecordHistory"></param>
        /// <returns>ApiResponse of Task</returns>
        public ApiResponse<Task> ExportRecordHistoriesWithHttpInfo (string viewId, ExportRecordHistory exportRecordHistory)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling RecordApi->ExportRecordHistories");
            // verify the required parameter 'exportRecordHistory' is set
            if (exportRecordHistory == null)
                throw new ApiException(400, "Missing required parameter 'exportRecordHistory' when calling RecordApi->ExportRecordHistories");

            var localVarPath = "/v1/views/{viewId}/record-histories/export";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (viewId != null) localVarPathParams.Add("viewId", this.Configuration.ApiClient.ParameterToString(viewId)); // path parameter
            if (exportRecordHistory != null && exportRecordHistory.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(exportRecordHistory); // http body (model) parameter
            }
            else
            {
                localVarPostBody = exportRecordHistory; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ExportRecordHistories", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Task</returns>
        public async System.Threading.Tasks.Task<Task> ExportRecordHistoriesAsync (string viewId, ExportRecordHistory exportRecordHistory, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Task> localVarResponse = await ExportRecordHistoriesWithHttpInfoAsync(viewId, exportRecordHistory, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Task)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Task>> ExportRecordHistoriesWithHttpInfoAsync (string viewId, ExportRecordHistory exportRecordHistory, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling RecordApi->ExportRecordHistories");
        ...
        /// <param name="fetchRequest">fetchRequest</param>
        /// <returns>List<RecordHistory></returns>
        public List<RecordHistory> FetchHistories (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest)
        {
             ApiResponse<List<RecordHistory>> localVarResponse = FetchHistoriesWithHttpInfo(viewId, recordId, fetchRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="fetchRequest">fetchRequest</param>
        /// <returns>ApiResponse of List<RecordHistory></returns>
        public ApiResponse<List<RecordHistory>> FetchHistoriesWithHttpInfo (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
            ...
            if (fetchRequest == null)
                throw new ApiException(400, "Missing required parameter 'fetchRequest' when calling RecordApi->FetchHistories");
            ...
            if (fetchRequest != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "fetchRequest", fetchRequest)); // query parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List<RecordHistory></returns>
        public async System.Threading.Tasks.Task<List<RecordHistory>> FetchHistoriesAsync (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<RecordHistory>> localVarResponse = await FetchHistoriesWithHttpInfoAsync(viewId, recordId, fetchRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;RecordHistory&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<RecordHistory>>> FetchHistoriesWithHttpInfoAsync (string viewId, string recordId, FetchRecordHistoryRequest fetchRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling RecordApi->FetchHistories");
