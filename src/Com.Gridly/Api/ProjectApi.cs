...
namespace Com.Gridly.Api
{
    ...
    public partial class ProjectApi : IProjectApi
    {
        ...
        public ApiResponse<Project> FindOneDetailWithHttpInfo (string expand, long projectId)
        {
            ...
            if (expand == null)
                throw new ApiException(400, "Missing required parameter 'expand' when calling ProjectApi->FindOneDetail");
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->FindOneDetail");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("FindOneDetail", localVarResponse);
                if (exception != null) throw exception;
            }
