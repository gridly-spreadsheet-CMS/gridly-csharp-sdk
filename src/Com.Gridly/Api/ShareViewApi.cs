...
namespace Com.Gridly.Api
{
    ...
    public interface IShareViewApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ShareView> CreateAsync(string viewId, CreateShareView createShareView, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<ShareView>> CreateWithHttpInfoAsync(string viewId, CreateShareView createShareView, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// delete
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ShareView</returns>
        System.Threading.Tasks.Task<ShareView> GetAsync(string viewId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ShareView)</returns>
        System.Threading.Tasks.Task<ApiResponse<ShareView>> GetWithHttpInfoAsync(string viewId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ShareViewApi : IShareViewApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ShareView</returns>
        public async System.Threading.Tasks.Task<ShareView> CreateAsync(string viewId, CreateShareView createShareView, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ShareView)</returns>
        public async System.Threading.Tasks.Task<Com.Gridly.Client.ApiResponse<ShareView>> CreateWithHttpInfoAsync(string viewId, CreateShareView createShareView, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ShareView</returns>
        public async System.Threading.Tasks.Task<ShareView> GetAsync(string viewId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ShareView)</returns>
        public async System.Threading.Tasks.Task<Com.Gridly.Client.ApiResponse<ShareView>> GetWithHttpInfoAsync(string viewId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
            {
