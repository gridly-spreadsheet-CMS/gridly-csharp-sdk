...
namespace Com.Gridly.Api
{
    ...
    public interface IPathApi : IApiAccessor
    {
        ...
        /// <param name="updatePath"></param>
        /// <returns>ApiResponse of PathSingle</returns>
        ApiResponse<PathSingle> UpdatePathNodeWithHttpInfo (string viewId, UpdatePath updatePath);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PathSingle</returns>
        System.Threading.Tasks.Task<PathSingle> UpdatePathNodeAsync (string viewId, UpdatePath updatePath, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PathSingle)</returns>
        System.Threading.Tasks.Task<ApiResponse<PathSingle>> UpdatePathNodeWithHttpInfoAsync (string viewId, UpdatePath updatePath, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PathApi : IPathApi
    {
        ...
        /// <param name="updatePath"></param>
        /// <returns>PathSingle</returns>
        public PathSingle UpdatePathNode (string viewId, UpdatePath updatePath)
        {
             ApiResponse<PathSingle> localVarResponse = UpdatePathNodeWithHttpInfo(viewId, updatePath);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updatePath"></param>
        /// <returns>ApiResponse of PathSingle</returns>
        public ApiResponse<PathSingle> UpdatePathNodeWithHttpInfo (string viewId, UpdatePath updatePath)
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling PathApi->UpdatePathNode");
            // verify the required parameter 'updatePath' is set
            if (updatePath == null)
                throw new ApiException(400, "Missing required parameter 'updatePath' when calling PathApi->UpdatePathNode");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdatePathNode", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PathSingle</returns>
        public async System.Threading.Tasks.Task<PathSingle> UpdatePathNodeAsync (string viewId, UpdatePath updatePath, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PathSingle> localVarResponse = await UpdatePathNodeWithHttpInfoAsync(viewId, updatePath, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PathSingle)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PathSingle>> UpdatePathNodeWithHttpInfoAsync (string viewId, UpdatePath updatePath, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new ApiException(400, "Missing required parameter 'viewId' when calling PathApi->UpdatePathNode");
