...
namespace Com.Gridly.Api
{
    ...
    public interface ITransmemApi : IApiAccessor
    {
        ...
        /// <param name="file"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> ImportTmxWithHttpInfo (string tmId, Object file);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ImportTmxAsync (string tmId, Object file, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ImportTmxWithHttpInfoAsync (string tmId, Object file, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List all available translation memories or create default one if there is no translation memory
        /// </summary>
        /// <remarks>
    ...
    public partial class TransmemApi : ITransmemApi
    {
        ...
        /// <param name="file"></param>
        /// <returns></returns>
        public void ImportTmx (string tmId, Object file)
        {
        ...
        /// <param name="file"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> ImportTmxWithHttpInfo (string tmId, Object file)
        {
            // verify the required parameter 'tmId' is set
            if (tmId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ImportTmxAsync (string tmId, Object file, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ImportTmxWithHttpInfoAsync (string tmId, Object file, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'tmId' is set
            if (tmId == null)
                throw new ApiException(400, "Missing required parameter 'tmId' when calling TransmemApi->ImportTmx");
