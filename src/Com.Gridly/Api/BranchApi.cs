...
namespace Com.Gridly.Api
{
    ...
    public interface IBranchApi : IApiAccessor
    {
        ...
        Branch Create (CreateBranch createBranch, string branchId = default(string), string gridId = default(string));
        ...
        ApiResponse<Branch> CreateWithHttpInfo (CreateBranch createBranch, string branchId = default(string), string gridId = default(string));
        /// <summary>
        /// delete
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Branch> CreateAsync (CreateBranch createBranch, string branchId = default(string), string gridId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Branch>> CreateWithHttpInfoAsync (CreateBranch createBranch, string branchId = default(string), string gridId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// delete
        /// </summary>
        /// <remarks>
    ...
    public partial class BranchApi : IBranchApi
    {
        ...
        /// <param name="gridId">gridId (optional)</param>
        /// <returns>Branch</returns>
        public Branch Create (CreateBranch createBranch, string branchId = default(string), string gridId = default(string))
        {
             ApiResponse<Branch> localVarResponse = CreateWithHttpInfo(createBranch, branchId, gridId);
        ...
        /// <param name="gridId">gridId (optional)</param>
        /// <returns>ApiResponse of Branch</returns>
        public ApiResponse<Branch> CreateWithHttpInfo (CreateBranch createBranch, string branchId = default(string), string gridId = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Branch</returns>
        public async System.Threading.Tasks.Task<Branch> CreateAsync (CreateBranch createBranch, string branchId = default(string), string gridId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Branch> localVarResponse = await CreateWithHttpInfoAsync(createBranch, branchId, gridId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Branch)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Branch>> CreateWithHttpInfoAsync (CreateBranch createBranch, string branchId = default(string), string gridId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'createBranch' is set
            if (createBranch == null)
                throw new ApiException(400, "Missing required parameter 'createBranch' when calling BranchApi->Create");
