...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateGlossary : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateGlossary(string name = default, string description = default, List<string> langs = default, List<GlossaryProject> projects = default, List<long> projectIds = default)
        {
            this.Name = name;
