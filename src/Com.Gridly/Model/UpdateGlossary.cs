...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateGlossary :  IEquatable<UpdateGlossary>, IValidatableObject
    {
        ...
        public UpdateGlossary(string name = default(string), string description = default(string), List<string> langs = default(List<string>), List<GlossaryProject> projects = default(List<GlossaryProject>), List<long> projectIds = default(List<long>))
        {
            this.Name = name;
