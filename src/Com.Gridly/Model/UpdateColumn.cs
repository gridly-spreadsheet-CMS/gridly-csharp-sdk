...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateColumn :  IEquatable<UpdateColumn>, IValidatableObject
    {
        ...
        public UpdateColumn(string description = default(string), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), string name = default(string), string newId = default(string), NumberFormat numberFormat = default(NumberFormat), List<string> selectionOptions = default(List<string>))
        {
