...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateColumn :  IEquatable<UpdateColumn>, IValidatableObject
    {
        ...
        public UpdateColumn(string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), LocalizationTypeEnum? localizationType = default(LocalizationTypeEnum?), List<string> selectionOptions = default(List<string>), Selection selection = default(Selection), NumberFormat numberFormat = default(NumberFormat), Reference reference = default(Reference), Formula formula = default(Formula), DateTimeFormat dateTimeFormat = default(DateTimeFormat), bool viewable = default(bool), bool editable = default(bool), LengthLimitSetting lengthLimitSetting = default(LengthLimitSetting), string newId = default(string))
        {
            this.Name = name;
        ...
        public bool Equals(UpdateColumn input)
        {
            ...
            return 
                ...
                (
                    this.LengthLimitSetting == input.LengthLimitSetting ||
                    (this.LengthLimitSetting != null &&
                    this.LengthLimitSetting.Equals(input.LengthLimitSetting))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LengthLimitSetting != null)
                    hashCode = hashCode * 59 + this.LengthLimitSetting.GetHashCode();
                if (this.NewId != null)
