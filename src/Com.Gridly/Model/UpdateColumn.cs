...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateColumn : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public UpdateColumn(string name = default, string description = default, TypeEnum? type = default, LanguageCodeEnum? languageCode = default, LocalizationTypeEnum? localizationType = default, List<string> selectionOptions = default, Selection selection = default, NumberFormat numberFormat = default, Reference reference = default, Formula formula = default, DateTimeFormat dateTimeFormat = default, bool viewable = default, bool editable = default, LengthLimitSetting lengthLimitSetting = default, string newId = default)
        {
            this.Name = name;
