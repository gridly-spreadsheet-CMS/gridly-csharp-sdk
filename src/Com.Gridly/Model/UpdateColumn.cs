...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateColumn :  IEquatable<UpdateColumn>, IValidatableObject
    {
        ...
        public UpdateColumn(string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), LocalizationTypeEnum? localizationType = default(LocalizationTypeEnum?), List<string> selectionOptions = default(List<string>), NumberFormat numberFormat = default(NumberFormat), Reference reference = default(Reference), Formula formula = default(Formula), DateTimeFormat dateTimeFormat = default(DateTimeFormat), bool viewable = default(bool), bool editable = default(bool), string newId = default(string))
        {
            this.Name = name;
