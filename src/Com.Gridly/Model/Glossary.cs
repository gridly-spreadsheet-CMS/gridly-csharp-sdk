...
namespace Com.Gridly.Model
{
    ...
    public partial class Glossary :  IEquatable<Glossary>, IValidatableObject
    {
        ...
        public Glossary(string id = default(string), string name = default(string), string description = default(string), List<string> langs = default(List<string>), List<GlossaryProject> projects = default(List<GlossaryProject>), List<long> projectIds = default(List<long>))
        {
            this.Id = id;
            this.Name = name;
