...
namespace Com.Gridly.Model
{
    ...
    public partial class RecordIdentifierWrapper :  IEquatable<RecordIdentifierWrapper>, IValidatableObject
    {
        ...
        public RecordIdentifierWrapper(string id = default(string), string path = default(string))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RecordIdentifierWrapper and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for RecordIdentifierWrapper and cannot be null");
            }
            else
            {
                this.Path = path;
