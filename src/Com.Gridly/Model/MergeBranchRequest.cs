...
namespace Com.Gridly.Model
{
    ...
    public partial class MergeBranchRequest :  IEquatable<MergeBranchRequest>, IValidatableObject
    {
        ...
        public MergeBranchRequest(List<MergeRecordOptionsEnum> mergeRecordOptions = default(List<MergeRecordOptionsEnum>), List<MergeRecordConflict> mergeRecordConflicts = default(List<MergeRecordConflict>), bool useLastMergeResolve = default(bool), bool checkMismatchedColumnType = default(bool), List<FilterField> query = default(List<FilterField>))
        {
        ...
        public bool Equals(MergeBranchRequest input)
        {
            ...
            return 
                ...
                (
                    this.CheckMismatchedColumnType == input.CheckMismatchedColumnType ||
                    (this.CheckMismatchedColumnType != null &&
                    this.CheckMismatchedColumnType.Equals(input.CheckMismatchedColumnType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CheckMismatchedColumnType != null)
                    hashCode = hashCode * 59 + this.CheckMismatchedColumnType.GetHashCode();
                if (this.Query != null)
