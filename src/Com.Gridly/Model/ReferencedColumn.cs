...
namespace Com.Gridly.Model
{
    ...
    public partial class ReferencedColumn : IValidatableObject
    {
        /// <summary>
        ...
        public ReferencedColumn(string id = default, string name = default, List<string> selectionOptions = default)
        {
            this.Id = id;
            this.Name = name;
