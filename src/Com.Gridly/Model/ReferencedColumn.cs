...
namespace Com.Gridly.Model
{
    ...
    public partial class ReferencedColumn :  IEquatable<ReferencedColumn>, IValidatableObject
    {
        ...
        public ReferencedColumn(string id = default(string), string name = default(string), List<string> selectionOptions = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Name = name;
