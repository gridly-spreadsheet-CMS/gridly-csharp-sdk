...
namespace Com.Gridly.Model
{
    ...
    /// CreateTransMem
    /// </summary>
    [DataContract(Name = "CreateTransMem")]
    public partial class CreateTransMem : IValidatableObject
    {
        ...
        public CreateTransMem(string name = default, string description = default, List<long> projectIds = default, bool fuzzyMatch = default, bool isDisabled = default, bool isPausedConsuming = default, bool contextLookup = default, TranslationStatus? populateTranslationStatus = default, bool allowAlternative = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateTransMem and cannot be null");
            }
            this.Name = name;
