...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateTransMem :  IEquatable<CreateTransMem>, IValidatableObject
    {
        ...
        public CreateTransMem(string name = default(string), string description = default(string), List<long> projectIds = default(List<long>), bool fuzzyMatch = default(bool), bool isDisabled = default(bool), bool isPausedConsuming = default(bool), bool contextLookup = default(bool), TranslationStatus? populateTranslationStatus = default(TranslationStatus?), bool allowAlternative = default(bool))
        {
