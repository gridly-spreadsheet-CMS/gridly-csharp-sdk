...
namespace Com.Gridly.Model
{
    ...
    public partial class Reference :  IEquatable<Reference>, IValidatableObject
    {
        ...
        public Reference(string gridId = default(string), string branchId = default(string), string columnId = default(string), TypeEnum? type = default(TypeEnum?), SelectionTypeEnum? selectionType = default(SelectionTypeEnum?))
        {
            // to ensure "gridId" is required (not null)
            if (gridId == null)
            {
                throw new InvalidDataException("gridId is a required property for Reference and cannot be null");
            }
            else
            {
                this.GridId = gridId;
            ...
            if (columnId == null)
            {
                throw new InvalidDataException("columnId is a required property for Reference and cannot be null");
            }
            else
            {
