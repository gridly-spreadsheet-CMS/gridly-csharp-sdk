...
namespace Com.Gridly.Model
{
    ...
    public partial class TransMem : IValidatableObject
    {
        ...
        public TransMem(string id = default, List<long> projectIds = default, bool isDisabled = default, bool isPausedConsuming = default, TranslationStatus? populateTranslationStatus = default, bool contextLookup = default, string name = default, string description = default, bool fuzzyMatch = default, bool allowAlternative = default, bool allowAlternativeHasSameRecordId = default)
        {
            this.Id = id;
