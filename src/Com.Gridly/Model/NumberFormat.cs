...
namespace Com.Gridly.Model
{
    ...
    public partial class NumberFormat :  IEquatable<NumberFormat>, IValidatableObject
    {
        ...
        public NumberFormat(string currencySymbol = default(string), int decimalPlaces = default(int), TypeEnum? type = default(TypeEnum?), bool use1000Separator = default(bool))
        {
