...
namespace Com.Gridly.Model
{
    ...
    public partial class Branch :  IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(string id = default(string), List<ViewColumn> columns = default(List<ViewColumn>), string defaultAccessViewId = default(string), string description = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), StatusEnum? status = default(StatusEnum?), bool isMaster = default(bool))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name="isMaster", EmitDefaultValue=false)]
