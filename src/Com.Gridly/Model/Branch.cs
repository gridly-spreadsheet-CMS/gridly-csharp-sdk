...
namespace Com.Gridly.Model
{
    ...
    public partial class Branch :  IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(List<ViewColumn> columns = default(List<ViewColumn>), string defaultAccessViewId = default(string), string description = default(string), string id = default(string), bool isMaster = default(bool), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), StatusEnum? status = default(StatusEnum?))
        {
