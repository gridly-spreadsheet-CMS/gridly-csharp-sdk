...
namespace Com.Gridly.Model
{
    ...
    public partial class Branch : IValidatableObject
    {
        ...
        public Branch(string id = default, List<ViewColumn> columns = default, string defaultAccessViewId = default, string description = default, bool isMaster = default, Dictionary<string, string> metadata = default, string name = default, RecordIdentifierTypeEnum? recordIdentifierType = default, StatusEnum? status = default)
        {
            this.Id = id;
