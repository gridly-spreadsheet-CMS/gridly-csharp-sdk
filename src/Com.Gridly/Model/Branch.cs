...
namespace Com.Gridly.Model
{
    ...
    public partial class Branch :  IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(string id = default(string), List<ViewColumn> columns = default(List<ViewColumn>), string defaultAccessViewId = default(string), string description = default(string), bool isMaster = default(bool), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), RecordIdentifierTypeEnum? recordIdentifierType = default(RecordIdentifierTypeEnum?), StatusEnum? status = default(StatusEnum?))
        {
            this.Id = id;
