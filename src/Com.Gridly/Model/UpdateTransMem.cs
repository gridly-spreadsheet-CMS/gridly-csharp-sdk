...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdateTransMem : IValidatableObject
    {
        ...
        public UpdateTransMem(string name = default, string description = default, List<long> projectIds = default, bool fuzzyMatch = default, bool isDisabled = default, bool isPausedConsuming = default, TranslationStatus? populateTranslationStatus = default, bool contextLookup = default, bool allowAlternative = default, bool allowAlternativeHasSameRecordId = default)
        {
            this.Name = name;
