...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateColumn :  IEquatable<CreateColumn>, IValidatableObject
    {
        ...
        public CreateColumn(string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), NumberFormat numberFormat = default(NumberFormat), List<string> selectionOptions = default(List<string>), Reference reference = default(Reference), string id = default(string))
        {
