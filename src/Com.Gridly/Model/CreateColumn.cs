...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateColumn :  IEquatable<CreateColumn>, IValidatableObject
    {
        ...
        public CreateColumn(string id = default(string), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), string name = default(string), NumberFormat numberFormat = default(NumberFormat), Reference reference = default(Reference), List<string> selectionOptions = default(List<string>), TypeEnum type = default(TypeEnum))
        {
