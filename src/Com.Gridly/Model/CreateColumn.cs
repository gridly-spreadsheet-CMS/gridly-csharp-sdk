...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateColumn :  IEquatable<CreateColumn>, IValidatableObject
    {
        ...
        public CreateColumn(string id = default(string), string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), bool editable = default(bool), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), LocalizationTypeEnum? localizationType = default(LocalizationTypeEnum?), NumberFormat numberFormat = default(NumberFormat), List<string> selectionOptions = default(List<string>), Selection selection = default(Selection), Reference reference = default(Reference), Formula formula = default(Formula), DateTimeFormat dateTimeFormat = default(DateTimeFormat), LengthLimitSetting lengthLimitSetting = default(LengthLimitSetting))
        {
