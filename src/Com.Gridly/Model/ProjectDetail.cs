...
namespace Com.Gridly.Model
{
    ...
    public partial class ProjectDetail :  IEquatable<ProjectDetail>, IValidatableObject
    {
        ...
        public ProjectDetail(long id = default(long), string name = default(string), string description = default(string), Role role = default(Role), List<Database> databases = default(List<Database>), List<Group> groups = default(List<Group>))
        {
            this.Id = id;
            this.Name = name;
