...
namespace Com.Gridly.Model
{
    ...
    public partial class UploadedFile :  IEquatable<UploadedFile>, IValidatableObject
    {
        ...
        public UploadedFile(string id = default(string), string originalName = default(string), string contentType = default(string), long size = default(long), string thumbnailId = default(string))
        {
            this.Id = id;
