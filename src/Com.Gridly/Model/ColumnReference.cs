...
namespace Com.Gridly.Model
{
    ...
    public partial class ColumnReference :  IEquatable<ColumnReference>, IValidatableObject
    {
        ...
        public ColumnReference(ReferencedGrid grid = default(ReferencedGrid), ReferencedColumn column = default(ReferencedColumn), TypeEnum? type = default(TypeEnum?), SelectionTypeEnum? selectionType = default(SelectionTypeEnum?))
        {
            this.Grid = grid;
            this.Column = column;
            this.Type = type;
