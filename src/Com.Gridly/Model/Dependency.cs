...
namespace Com.Gridly.Model
{
    ...
    public partial class Dependency :  IEquatable<Dependency>, IValidatableObject
    {
        ...
        public Dependency(string id = default(string), string sourceColumnId = default(string), string targetColumnId = default(string))
        {
            // to ensure "sourceColumnId" is required (not null)
            if (sourceColumnId == null)
            {
                throw new InvalidDataException("sourceColumnId is a required property for Dependency and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetColumnId is a required property for Dependency and cannot be null");
            }
            else
            {
