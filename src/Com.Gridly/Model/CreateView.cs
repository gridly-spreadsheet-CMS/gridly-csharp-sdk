...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateView :  IEquatable<CreateView>, IValidatableObject
    {
        ...
        public CreateView(string name = default(string), string gridId = default(string), List<AddViewColumn> columns = default(List<AddViewColumn>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateView and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (gridId == null)
            {
                throw new InvalidDataException("gridId is a required property for CreateView and cannot be null");
            }
            else
            {
                this.GridId = gridId;
