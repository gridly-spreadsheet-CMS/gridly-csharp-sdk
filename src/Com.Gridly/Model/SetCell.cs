...
namespace Com.Gridly.Model
{
    ...
    public partial class SetCell :  IEquatable<SetCell>, IValidatableObject
    {
        ...
        public SetCell(string columnId = default(string), DependencyStatusEnum? dependencyStatus = default(DependencyStatusEnum?), List<string> referencedIds = default(List<string>), Object value = default(Object))
        {
