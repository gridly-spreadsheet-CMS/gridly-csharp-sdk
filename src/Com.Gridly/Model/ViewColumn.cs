...
namespace Com.Gridly.Model
{
    ...
    public partial class ViewColumn :  IEquatable<ViewColumn>, IValidatableObject
    {
        ...
        public ViewColumn(string dependsOn = default(string), string id = default(string), bool isSource = default(bool), bool isTarget = default(bool), string languageCode = default(string), string name = default(string), NumberFormat numberFormat = default(NumberFormat), ColumnReference reference = default(ColumnReference), List<string> selectionOptions = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
