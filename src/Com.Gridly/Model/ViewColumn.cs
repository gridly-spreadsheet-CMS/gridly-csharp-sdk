...
namespace Com.Gridly.Model
{
    ...
    public partial class ViewColumn : IValidatableObject
    {
        /// <summary>
        ...
        public ViewColumn(string id = default, DateTimeFormat dateTimeFormat = default, string dependsOn = default, string description = default, bool editable = default, Formula formula = default, bool isSource = default, bool isTarget = default, string languageCode = default, string languageName = default, LengthLimitSetting lengthLimitSetting = default, LocalizationTypeEnum? localizationType = default, string name = default, NumberFormat numberFormat = default, ColumnReference reference = default, Selection selection = default, List<string> selectionOptions = default, TypeEnum? type = default)
        {
            this.Id = id;
