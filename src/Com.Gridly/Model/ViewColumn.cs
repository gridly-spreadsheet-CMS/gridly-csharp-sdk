...
namespace Com.Gridly.Model
{
    ...
    public partial class ViewColumn :  IEquatable<ViewColumn>, IValidatableObject
    {
        ...
        public ViewColumn(string id = default(string), DateTimeFormat dateTimeFormat = default(DateTimeFormat), string dependsOn = default(string), string description = default(string), bool editable = default(bool), Formula formula = default(Formula), bool isSource = default(bool), bool isTarget = default(bool), string languageCode = default(string), string languageName = default(string), LengthLimitSetting lengthLimitSetting = default(LengthLimitSetting), LocalizationTypeEnum? localizationType = default(LocalizationTypeEnum?), string name = default(string), NumberFormat numberFormat = default(NumberFormat), ColumnReference reference = default(ColumnReference), Selection selection = default(Selection), List<string> selectionOptions = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name="languageName", EmitDefaultValue=true)]
