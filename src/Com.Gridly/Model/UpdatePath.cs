...
namespace Com.Gridly.Model
{
    ...
    public partial class UpdatePath :  IEquatable<UpdatePath>, IValidatableObject
    {
        ...
        public UpdatePath(string path = default(string), string newName = default(string))
        {
            // to ensure "newName" is required (not null)
            if (newName == null)
            {
                throw new InvalidDataException("newName is a required property for UpdatePath and cannot be null");
            }
            else
            {
