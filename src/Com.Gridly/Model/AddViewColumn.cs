...
namespace Com.Gridly.Model
{
    ...
    public partial class AddViewColumn :  IEquatable<AddViewColumn>, IValidatableObject
    {
        ...
        public AddViewColumn(string id = default(string), bool editable = default(bool), string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), LanguageCodeEnum? languageCode = default(LanguageCodeEnum?), LocalizationTypeEnum? localizationType = default(LocalizationTypeEnum?), NumberFormat numberFormat = default(NumberFormat), List<string> selectionOptions = default(List<string>), Selection selection = default(Selection), Reference reference = default(Reference), Formula formula = default(Formula), DateTimeFormat dateTimeFormat = default(DateTimeFormat))
        {
            this.Id = id;
