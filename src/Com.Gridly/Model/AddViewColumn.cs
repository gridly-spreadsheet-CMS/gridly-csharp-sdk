...
namespace Com.Gridly.Model
{
    ...
    public partial class AddViewColumn : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public AddViewColumn(string id = default, bool editable = default, string name = default, string description = default, TypeEnum? type = default, LanguageCodeEnum? languageCode = default, LocalizationTypeEnum? localizationType = default, NumberFormat numberFormat = default, List<string> selectionOptions = default, Selection selection = default, Reference reference = default, Formula formula = default, DateTimeFormat dateTimeFormat = default)
        {
            this.Id = id;
