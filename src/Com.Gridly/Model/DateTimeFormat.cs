...
namespace Com.Gridly.Model
{
    ...
    public partial class DateTimeFormat : IValidatableObject
    {
        /// <summary>
        ...
        public DateTimeFormat(string dateFormat = default, string timeFormat = default, string zoneOffset = default, bool showTimeZone = default)
        {
