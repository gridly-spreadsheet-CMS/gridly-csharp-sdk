...
namespace Com.Gridly.Model
{
    ...
    public partial class Project :  IEquatable<Project>, IValidatableObject
    {
        ...
        public Project(long id = default(long), long companyId = default(long), string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
