...
namespace Com.Gridly.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CellHistory :  IEquatable<CellHistory>, IValidatableObject
    {
        /// <summary>
        ...
        public CellHistory(DependencyStatusEnum? dependencyStatus = default(DependencyStatusEnum?), SourceStatusEnum? sourceStatus = default(SourceStatusEnum?), string columnId = default(string), Object value = default(Object))
        {
        ...
        {
            return this.Equals(input as CellHistory);
        }

        /// <summary>
        /// Returns true if CellHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of CellHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CellHistory input)
        {
            if (input == null)
                return false;
