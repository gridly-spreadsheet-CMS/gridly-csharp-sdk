...
namespace Com.Gridly.Model
{
    ...
    public partial class CreateGrid :  IEquatable<CreateGrid>, IValidatableObject
    {
        ...
        public CreateGrid(string name = default(string), string templateGridId = default(string), RecordIdentifierTypeEnum? recordIdentifierType = default(RecordIdentifierTypeEnum?), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateGrid and cannot be null");
            }
            else
            {
                this.Name = name;
