...
namespace Com.Gridly.Model
{
    ...
    public partial class Group :  IEquatable<Group>, IValidatableObject
    {
        ...
        public Group(string id = default(string), long groupId = default(long), long companyId = default(long), string name = default(string), string logoUrl = default(string), TypeEnum? type = default(TypeEnum?), ShareTypeEnum? shareType = default(ShareTypeEnum?), DateTime createdDate = default(DateTime), DateTime lastModifiedDate = default(DateTime), bool systemGroup = default(bool), bool isSystemGroup = default(bool))
        {
            this.Id = id;
